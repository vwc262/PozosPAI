...
Shader "Boy/BoyEndOfTheWorld"
{
	Properties
	{
		...
		_CloudsTilling("CloudsTilling", Vector) = (10,1,0,0)
		_CloudsSpeed("CloudsSpeed", Vector) = (0.1,0,0,0)
		_NoiseScale("NoiseScale", Range( 0 , 10)) = 1.352941
		_NoiseTilling("NoiseTilling", Vector) = (10,1,0,0)
		_NoiseSpeed("NoiseSpeed", Vector) = (0.1,-0.25,0,0)
		_EmmitColor("EmmitColor", Color) = (0.1237095,0.1670226,0.1886792,1)
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord15 = packedInput.ase_texcoord1.xy * _CloudsTilling + float2( 0,0 );
				float2 panner12 = ( 1.0 * _Time.y * _CloudsSpeed + texCoord15);
				float2 uv_Mask = packedInput.ase_texcoord1.xy * _Mask_ST.xy + _Mask_ST.zw;
				float4 temp_output_34_0 = ( tex2D( _Clouds, panner12 ) * tex2D( _Mask, uv_Mask ) );
				float4 temp_output_37_0 = ( _EmmitColor * temp_output_34_0 );
				
				float2 texCoord30 = packedInput.ase_texcoord1.xy * _NoiseTilling + float2( 0,0 );
				float2 panner27 = ( 1.0 * _Time.y * _NoiseSpeed + texCoord30);
				float simplePerlin2D25 = snoise( panner27*_NoiseScale );
				...
				surfaceDescription.Alpha = ( temp_output_34_0 * simplePerlin2D25 * _Opacity ).r;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord15 = packedInput.ase_texcoord.xy * _CloudsTilling + float2( 0,0 );
				float2 panner12 = ( 1.0 * _Time.y * _CloudsSpeed + texCoord15);
				float2 uv_Mask = packedInput.ase_texcoord.xy * _Mask_ST.xy + _Mask_ST.zw;
				float4 temp_output_34_0 = ( tex2D( _Clouds, panner12 ) * tex2D( _Mask, uv_Mask ) );
				float2 texCoord30 = packedInput.ase_texcoord.xy * _NoiseTilling + float2( 0,0 );
				float2 panner27 = ( 1.0 * _Time.y * _NoiseSpeed + texCoord30);
				float simplePerlin2D25 = snoise( panner27*_NoiseScale );
				simplePerlin2D25 = simplePerlin2D25*0.5 + 0.5;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord15 = packedInput.ase_texcoord2.xy * _CloudsTilling + float2( 0,0 );
				float2 panner12 = ( 1.0 * _Time.y * _CloudsSpeed + texCoord15);
				float2 uv_Mask = packedInput.ase_texcoord2.xy * _Mask_ST.xy + _Mask_ST.zw;
				float4 temp_output_34_0 = ( tex2D( _Clouds, panner12 ) * tex2D( _Mask, uv_Mask ) );
				float4 temp_output_37_0 = ( _EmmitColor * temp_output_34_0 );
				
				float2 texCoord30 = packedInput.ase_texcoord2.xy * _NoiseTilling + float2( 0,0 );
				float2 panner27 = ( 1.0 * _Time.y * _NoiseSpeed + texCoord30);
				float simplePerlin2D25 = snoise( panner27*_NoiseScale );
				simplePerlin2D25 = simplePerlin2D25*0.5 + 0.5;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord15 = packedInput.ase_texcoord3.xy * _CloudsTilling + float2( 0,0 );
				float2 panner12 = ( 1.0 * _Time.y * _CloudsSpeed + texCoord15);
				float2 uv_Mask = packedInput.ase_texcoord3.xy * _Mask_ST.xy + _Mask_ST.zw;
				float4 temp_output_34_0 = ( tex2D( _Clouds, panner12 ) * tex2D( _Mask, uv_Mask ) );
				float2 texCoord30 = packedInput.ase_texcoord3.xy * _NoiseTilling + float2( 0,0 );
				float2 panner27 = ( 1.0 * _Time.y * _NoiseSpeed + texCoord30);
				float simplePerlin2D25 = snoise( panner27*_NoiseScale );
				simplePerlin2D25 = simplePerlin2D25*0.5 + 0.5;
...
ASEEND*/
//CHKSM=A6A29445C0B91482614B34CF4DEC3ACF4322BAEB